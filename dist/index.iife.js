var WebAudioWave = (function () {
  ...
  */
  var _export$1 = function (options, source) {
    ...
    for (key in source) {
      ...
      if (options.bind && USE_NATIVE) resultProperty = bind$d(sourceProperty, global$1e);
  ...
  $$w({ target: 'Object', stat: true, forced: !NATIVE_SYMBOL$2, sham: !DESCRIPTORS$k }, {
    // `Object.create` method
    // https://tc39.es/ecma262/#sec-object.create
    create: $create,
    // `Object.defineProperty` method
  ...
  $$w({ target: 'Object', stat: true, forced: fails$H(function () { getOwnPropertySymbolsModule$3.f(1); }) }, {
  ...
  // https://tc39.es/ecma262/#sec-object.defineproperty
  // eslint-disable-next-line es/no-object-defineproperty -- safe
  $$t({ target: 'Object', stat: true, forced: Object.defineProperty !== defineProperty$f, sham: !DESCRIPTORS$j }, {
  ...
  var uncurryThis$E = NATIVE_BIND$3 && bind$a.bind(call$l, call$l);
  ...
  */
  ...
  $$q({ target: 'Reflect', stat: true, forced: FORCED$7, sham: FORCED$7 }, {
  ...
  // `Object.getOwnPropertyDescriptor` method
  // https://tc39.es/ecma262/#sec-object.getownpropertydescriptor
  $$o({ target: 'Object', stat: true, forced: FORCED$6, sham: !DESCRIPTORS$9 }, {
  ...
  // `Object.create` method
  // https://tc39.es/ecma262/#sec-object.create
  $$l({ target: 'Object', stat: true, sham: !DESCRIPTORS$8 }, {
    create: create$5
  });
  ...
  $$j({ global: true, wrap: true, forced: FORCED$5 }, {
  ...
  // statics
  $$j({ target: PROMISE, stat: true, forced: FORCED$5 }, {
  ...
  if ($stringify) {
    ...
    $$9({ target: 'JSON', stat: true, forced: FORCED$4 }, {
      // eslint-disable-next-line no-unused-vars -- required for `.length`
      stringify: function stringify(it, replacer, space) {
  ...
  // https://tc39.es/ecma262/#sec-function.prototype.bind
  $$4({ target: 'Function', proto: true, forced: Function.bind !== bind$3 }, {
    bind: bind$3
  });
