var WebAudioWave = (function () {
  ...
  var functionApply$1 = typeof Reflect == 'object' && Reflect.apply || (bind$g ? call$s.bind(apply$c) : function () {
  ...
  */
  ...
  // `Array.from` method
  // https://tc39.es/ecma262/#sec-array.from
  $$y({ target: 'Array', stat: true, forced: INCORRECT_ITERATION$1 }, {
    from: from
  });
  ...
  $$x({ target: 'Array', proto: true, forced: FORCED$9 }, {
  ...
  $$w({ global: true, wrap: true, forced: !NATIVE_SYMBOL$2, sham: !NATIVE_SYMBOL$2 }, {
    Symbol: $Symbol
  });
  ...
  $$w({ target: SYMBOL, stat: true, forced: !NATIVE_SYMBOL$2 }, {
    // `Symbol.for` method
  ...
  $$w({ target: 'Object', stat: true, forced: !NATIVE_SYMBOL$2, sham: !DESCRIPTORS$i }, {
    // `Object.create` method
    // https://tc39.es/ecma262/#sec-object.create
    create: $create,
    // `Object.defineProperty` method
  ...
  $$w({ target: 'Object', stat: true, forced: !NATIVE_SYMBOL$2 }, {
    // `Object.getOwnPropertyNames` method
    // https://tc39.es/ecma262/#sec-object.getownpropertynames
  ...
  $$w({ target: 'Object', stat: true, forced: fails$E(function () { getOwnPropertySymbolsModule$3.f(1); }) }, {
  ...
  // `Object.defineProperty` method
  // https://tc39.es/ecma262/#sec-object.defineproperty
  $$t({ target: 'Object', stat: true, forced: !DESCRIPTORS$h, sham: !DESCRIPTORS$h }, {
  ...
  */
  ...
  $$s({ target: 'RegExp', proto: true, forced: /./.exec !== exec$3 }, {
    exec: exec$3
  });
  ...
  // eslint-disable-next-line es/no-reflect -- safe
  var functionApply = typeof Reflect == 'object' && Reflect.apply || (bind$a ? call$f.bind(apply$9) : function () {
  ...
  $$r({ target: 'Object', stat: true, forced: Object.assign !== assign }, {
    assign: assign
  });
  ...
  $$q({ target: 'Reflect', stat: true, forced: FORCED$8, sham: FORCED$8 }, {
  ...
  // `Object.getOwnPropertyDescriptor` method
  // https://tc39.es/ecma262/#sec-object.getownpropertydescriptor
  $$o({ target: 'Object', stat: true, forced: FORCED$7, sham: !DESCRIPTORS$8 }, {
  ...
  // `Object.getPrototypeOf` method
  // https://tc39.es/ecma262/#sec-object.getprototypeof
  $$m({ target: 'Object', stat: true, forced: FAILS_ON_PRIMITIVES$2, sham: !CORRECT_PROTOTYPE_GETTER$1 }, {
  ...
  // `Array.prototype.indexOf` method
  // https://tc39.es/ecma262/#sec-array.prototype.indexof
  $$a({ target: 'Array', proto: true, forced: NEGATIVE_ZERO$1 || !STRICT_METHOD$1 }, {
  ...
  if ($stringify) {
    ...
    $$9({ target: 'JSON', stat: true, forced: FORCED$5 }, {
      // eslint-disable-next-line no-unused-vars -- required for `.length`
      stringify: function stringify(it, replacer, space) {
