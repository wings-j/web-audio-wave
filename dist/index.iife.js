var WebAudioWave = (function () {
   ...
   */
  var baseSetToString = !defineProperty$i
    ? identity
  ...
  var bind$h = FunctionPrototype$6.bind
  var call$w = FunctionPrototype$6.call
  var callBind$1 = bind$h && bind$h.bind(call$w)

  var functionUncurryThis$1 = bind$h
    ? function (fn) {
  ...
  var getBuiltIn$j = function (namespace, method) {
    return arguments.length < 2
      ? aFunction$1(path$l[namespace]) || aFunction$1(global$1s[namespace])
  ...
  var useSymbolAsUid$1 = NATIVE_SYMBOL$4 && !Symbol.sham && typeof Symbol.iterator == 'symbol'
  ...
  var classof$m = TO_STRING_TAG_SUPPORT$5
    ? classofRaw$2
    : function (it) {
        var O, tag, result
        return it === undefined
          ...
          ? 'Null'
          : // @@toStringTag case
          typeof (tag = tryGet$1((O = Object$b(it)), TO_STRING_TAG$7)) == 'string'
          ? tag
          : // builtinTag case
          CORRECT_ARGUMENTS$1
          ? classofRaw$2(O)
          : // ES3 arguments fallback
          (result = classofRaw$2(O)) == 'Object' && isCallable$C(O.callee)
          ? 'Arguments'
          : result
      }
  ...
  var createMethod$7 = function (CONVERT_TO_STRING) {
    return function ($this, pos) {
      ...
      return first < 0xd800 || first > 0xdbff || position + 1 === size || (second = charCodeAt$2(S, position + 1)) < 0xdc00 || second > 0xdfff
        ? CONVERT_TO_STRING
          ? charAt$7(S, position)
          : first
        : CONVERT_TO_STRING
  ...
  var functionCall$1 = call$v.bind
    ? call$v.bind(call$v)
    : function () {
  ...
  var isSymbol$7 = USE_SYMBOL_AS_UID$2
    ? function (it) {
  ...
  objectDefineProperty$1.f = DESCRIPTORS$n
    ? $defineProperty$2
  ...
  var createNonEnumerableProperty$h = DESCRIPTORS$m
  ...
  var bind$g = FunctionPrototype$5.bind
  ...
  objectGetOwnPropertyDescriptor$1.f = DESCRIPTORS$l
  ...
  var isForced$4 = function (feature, detection) {
    ...
    return value == POLYFILL$1 ? true : value == NATIVE$1 ? false : isCallable$v(detection) ? fails$K(detection) : !!detection
  }
  ...
  var bind$f = uncurryThis$L(uncurryThis$L.bind)
  ...
  */
  var _export$1 = function (options, source) {
    ...
    for (key in source) {
      ...
      if (options.bind && USE_NATIVE) resultProperty = bind$e(sourceProperty, global$1c)
  ...
  var objectDefineProperties$1 = DESCRIPTORS$j
  ...
  var objectGetPrototypeOf$1 = CORRECT_PROTOTYPE_GETTER$2
    ? Object$8.getPrototypeOf
    : function (O) {
  ...
  var objectToString$1 = TO_STRING_TAG_SUPPORT$4
    ? {}.toString
    : function toString() {
  ...
  var defineIterator$5 = function (Iterable, NAME, IteratorConstructor, next, DEFAULT, IS_SET, FORCED) {
    ...
    var nativeIterator = IterablePrototype[ITERATOR$a] || IterablePrototype['@@iterator'] || (DEFAULT && IterablePrototype[DEFAULT])
    ...
    if (PROPER_FUNCTION_NAME$4 && DEFAULT == VALUES$1 && nativeIterator && nativeIterator.name !== VALUES$1) {
      {
        ...
        defaultIterator = function values() {
          return call$q(nativeIterator, this)
        }
      }
    }
  ...
  var getIteratorMethod$6 = function (it) {
    if (it != undefined) return getMethod$6(it, ITERATOR$8) || getMethod$6(it, '@@iterator') || Iterators$7[classof$h(it)]
  }
  ...
  $$x(
    { target: 'Array', proto: true, forced: FORCED$9 },
    {
  ...
  var defineWellKnownSymbol$l = function (NAME) {
    ...
    if (!hasOwn$h(Symbol, NAME))
      defineProperty$e(Symbol, NAME, {
  ...
  var $propertyIsEnumerable$1 = function propertyIsEnumerable(V) {
    ...
    return enumerable || !hasOwn$g(this, P) || !hasOwn$g(AllSymbols, P) || (hasOwn$g(this, HIDDEN) && this[HIDDEN][P]) ? enumerable : true
  }
  ...
  $$w(
    { target: 'Object', stat: true, forced: !NATIVE_SYMBOL$2, sham: !DESCRIPTORS$i },
    {
      // `Object.create` method
      // https://tc39.es/ecma262/#sec-object.create
      create: $create,
  ...
  $$w(
    {
      ...
      forced: fails$E(function () {
        getOwnPropertySymbolsModule$3.f(1)
      })
    },
    {
  ...
  // https://tc39.es/ecma262/#sec-object.defineproperty
  $$t(
    { target: 'Object', stat: true, forced: !DESCRIPTORS$h, sham: !DESCRIPTORS$h },
    {
  ...
  var callBind = bind$b && bind$b.bind(call$k)

  var functionUncurryThis = bind$b
    ? function (fn) {
  ...
  // `Object.getOwnPropertyDescriptor` method
  // https://tc39.es/ecma262/#sec-object.getownpropertydescriptor
  objectGetOwnPropertyDescriptor.f = DESCRIPTORS$f
  ...
  // `Object.defineProperty` method
  // https://tc39.es/ecma262/#sec-object.defineproperty
  objectDefineProperty.f = DESCRIPTORS$e
    ? $defineProperty
    : function defineProperty(O, P, Attributes) {
        anObject$j(O)
        P = toPropertyKey$1(P)
  ...
  var createNonEnumerableProperty$b = DESCRIPTORS$d
    ? function (object, key, value) {
  ...
  var isForced$2 = function (feature, detection) {
    ...
    return value == POLYFILL ? true : value == NATIVE ? false : isCallable$f(detection) ? fails$y(detection) : !!detection
  }
  ...
  */
  ...
  var classof$c = TO_STRING_TAG_SUPPORT$2
    ...
    : function (it) {
        ...
        return it === undefined
          ...
          ? 'Null'
          : // @@toStringTag case
          typeof (tag = tryGet((O = Object$3(it)), TO_STRING_TAG$3)) == 'string'
          ? tag
          : // builtinTag case
          CORRECT_ARGUMENTS
          ? classofRaw(O)
          : // ES3 arguments fallback
          (result = classofRaw(O)) == 'Object' && isCallable$e(O.callee)
          ? 'Arguments'
          : result
      }
  ...
  // https://tc39.es/ecma262/#sec-object.defineproperties
  // eslint-disable-next-line es/no-object-defineproperties -- safe
  var objectDefineProperties = DESCRIPTORS$b
    ? Object.defineProperties
    : function defineProperties(O, Properties) {
        anObject$g(O)
  ...
  $$s(
    { target: 'RegExp', proto: true, forced: /./.exec !== exec$3 },
    {
      exec: exec$3
    }
  )
  ...
  var createMethod$3 = function (CONVERT_TO_STRING) {
    return function ($this, pos) {
      ...
      return first < 0xd800 || first > 0xdbff || position + 1 === size || (second = charCodeAt$1(S, position + 1)) < 0xdc00 || second > 0xdfff
        ? CONVERT_TO_STRING
          ? charAt$4(S, position)
          : first
        : CONVERT_TO_STRING
      ...
      return [
        ...
        function (string, limit) {
          ...
          while (q < S.length) {
            ...
            var e
            if (z === null || (e = min$4(toLength$7(splitter.lastIndex + (UNSUPPORTED_Y ? q : 0)), S.length)) === p) {
  ...
  $$q(
    { target: 'Reflect', stat: true, forced: FORCED$8, sham: FORCED$8 },
    {
      construct: function construct(Target, args /* , newTarget */) {
        ...
        if (Target == newTarget) {
          ...
          return new (apply$7(bind$9, Target, $args))()
        }
  ...
  function get$1(target, propertyKey /* , receiver */) {
    ...
    if (descriptor) return isDataDescriptor(descriptor) ? descriptor.value : descriptor.get === undefined ? undefined : call$b(descriptor.get, receiver)
  ...
  var FAILS_ON_PRIMITIVES$3 = fails$p(function () {
  ...
  // https://tc39.es/ecma262/#sec-object.getownpropertydescriptor
  $$o(
    { target: 'Object', stat: true, forced: FORCED$7, sham: !DESCRIPTORS$8 },
    {
  ...
  var FAILS_ON_PRIMITIVES$2 = fails$o(function () {
  ...
  // https://tc39.es/ecma262/#sec-object.getprototypeof
  $$m(
    { target: 'Object', stat: true, forced: FAILS_ON_PRIMITIVES$2, sham: !CORRECT_PROTOTYPE_GETTER$1 },
    {
  ...
  // https://tc39.es/ecma262/#sec-object.create
  $$l(
    { target: 'Object', stat: true, sham: !DESCRIPTORS$7 },
    {
      create: create$5
    }
  )
  ...
  if (!queueMicrotask) {
    ...
    if (!IS_IOS && !IS_NODE$1 && !IS_WEBOS_WEBKIT && MutationObserver && document$2) {
      ...
      macrotask = bind$6(macrotask, global$s)
      notify$1 = function () {
        macrotask(flush)
      }
    }
    ...
    try {
      ...
      if (then) {
        microtask(function () {
          ...
          try {
            call$9(then, value, bind$5(internalResolve, wrapper, state), bind$5(internalReject, wrapper, state))
          } catch (error) {
      ...
      allSettled: function allSettled(iterable) {
        ...
        var result = perform$2(function () {
          ...
          iterate$3(iterable, function (promise) {
            ...
            var alreadyCalled = false
            remaining++
            call$8(promiseResolve, C, promise).then(
              function (value) {
                if (alreadyCalled) return
                alreadyCalled = true
      ...
      any: function any(iterable) {
        ...
        var result = perform$1(function () {
          ...
          iterate$2(iterable, function (promise) {
            ...
            remaining++
            call$7(promiseResolve, C, promise).then(
              function (value) {
  ...
  var FAILS_ON_PRIMITIVES$1 = fails$k(function () {
    nativeKeys(1)
  })
  ...
  entryVirtual$3('String').includes
  ...
  // https://tc39.es/ecma262/#sec-array.prototype.indexof
  $$a(
    { target: 'Array', proto: true, forced: NEGATIVE_ZERO$1 || !STRICT_METHOD$1 },
    {
  ...
  if ($stringify) {
    ...
    $$9(
      { target: 'JSON', stat: true, forced: FORCED$5 },
      {
        // eslint-disable-next-line no-unused-vars -- required for `.length`
        stringify: function stringify(it, replacer, space) {
  ...
  var collection$1 = function (CONSTRUCTOR_NAME, wrapper, common) {
    ...
    if (
      !DESCRIPTORS$5 ||
      !isCallable$8(NativeConstructor) ||
      !(
        IS_WEAK ||
      ...
      IS_WEAK ||
        defineProperty$4(Prototype, 'size', {
          configurable: true,
          get: function () {
  ...
  if (DESCRIPTORS$2 && !hasOwn$1(TypedArrayPrototype$1, TO_STRING_TAG)) {
    ...
    defineProperty(TypedArrayPrototype$1, TO_STRING_TAG, {
      get: function () {
  ...
  var getIteratorMethod$2 = function (it) {
    if (it != undefined) return getMethod$2(it, ITERATOR$2) || getMethod$2(it, '@@iterator') || Iterators$1[classof$2(it)]
  }
  ...
  exportTypedArrayMethod$k('fill', function fill(value /* , start, end */) {
    ...
    return call$2($fill, aTypedArray$j(this), value, length > 1 ? arguments[1] : undefined, length > 2 ? arguments[2] : undefined)
  })
  ...
  var mergeSort = function (array, comparefn) {
    ...
    return length < 8
      ...
      : merge(array, mergeSort(arraySlice$1(array, 0, middle), comparefn), mergeSort(arraySlice$1(array, middle), comparefn), comparefn)
  }
  ...
  exportTypedArrayMethod$1(
    ...
    function toLocaleString() {
      return apply$1($toLocaleString, TO_LOCALE_STRING_BUG ? arraySlice(aTypedArray(this)) : aTypedArray(this), arraySlice(arguments))
    },
    FORCED
  )
