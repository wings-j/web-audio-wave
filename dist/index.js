...
var splice = _spliceInstanceProperty(arrayProto);
/**
...
var maskSrcKey = function () {
  var uid = /[^.]+$/.exec(coreJsData$1 && _keysInstanceProperty(coreJsData$1) && _keysInstanceProperty(coreJsData$1).IE_PROTO || '');
...
function getMapData(map, key) {
  ...
  return isKeyable(key) ? data[typeof key == 'string' ? 'string' : 'hash'] : _mapInstanceProperty(data);
}
/**
...
function cloneBuffer(buffer, isDeep) {
  if (isDeep) {
    return _sliceInstanceProperty(buffer).call(buffer);
  }
...
var objectCreate = _Object$create;
/**
...
var getPrototype = overArg(_Object$getPrototypeOf, Object);
...
var WebAudioWave = /*#__PURE__*/function () {
  ...
  _createClass(WebAudioWave, [{
    ...
    value: function callback() {
      ...
      this.visualize.update((_this$fft$get = (_this$fft = this.fft) === null || _this$fft === void 0 ? void 0 : _this$fft.get()) !== null && _this$fft$get !== void 0 ? _this$fft$get : []);
    }
    /**
     * 播放
     */
